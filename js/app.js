(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".personnel__slider")) new core(".personnel__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".story__slider")) new core(".story__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 40,
                ...
                speed: 800,
                pagination: {
                    el: ".story__slider .swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".story__slider .swiper-button-prev",
                    nextEl: ".story__slider .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".tabs-compound__slider")) new core(".tabs-compound__slider", {
                modules: [ Navigation, Pagination, Parallax ],
                observer: true,
                observeParents: true,
                speed: 1200,
                ...
                loop: true,
                pagination: {
                    el: ".tabs-compound__slider .swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".tabs-compound__slider .swiper-button-prev",
                    nextEl: ".tabs-compound__slider .swiper-button-next"
                },
                on: {}
            });
        }
        ...
        const menuArrow = document.querySelector(".menu__list");
        document.addEventListener("click", menu);
        function menu(event) {
            if (event.target.closest(".search-header__icon")) search.classList.toggle("_open");
            if (!event.target.closest(".search-header")) search.classList.remove("_open");
            if (event.target.closest(".menu__link-arrow")) menuArrow.classList.toggle("_active");
            if (!event.target.closest(".menu__list")) menuArrow.classList.remove("_active");
        }
